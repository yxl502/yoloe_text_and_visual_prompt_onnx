...
"""
python yoloe_onnx_infer.py --mobile_clip_onnx_path  mobileclip.onnx --yoloe_onnx_path  yoloe_v8l_det.onnx --img_path ultralytics/assets/cat_dog.jpeg --text_prompt "cat,dog"    
